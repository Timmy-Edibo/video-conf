...
let MENU_LIST = [
    ...
    data: [
      {
        ...
        zhDocUrl:
          "https://doc.shengwang.cn/doc/rtc/javascript/basic-features/screen-share",
        enDocUrl:
      ...
      },
      {
        ...
        zhDocUrl:
          "https://doc.shengwang.cn/doc/rtc/javascript/basic-features/video-profile",
        enDocUrl:
      ...
      },
      {
        ...
        zhDocUrl:
          "https://doc.shengwang.cn/doc/rtc/javascript/advanced-features/in-call-quality",
        enDocUrl:
          "https://api-ref.agora.io/en/voice-sdk/web/4.x/interfaces/networkquality.html",
        githubUrl:
      ...
      },
      {
        ...
        zhDocUrl:
          "https://doc.shengwang.cn/doc/rtc/javascript/basic-features/join-leave-channel",
        enDocUrl:
      ...
      },
      {
        ...
        zhDocUrl:
          "https://doc.shengwang.cn/doc/rtc/javascript/advanced-features/content-inspect",
        enDocUrl:
      ...
      },
      {
        ...
        enDocUrl:
          "https://docs.agora.io/en/video-calling/enable-features/geofencing?platform=web",
        githubUrl:
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        zhDocUrl:
          "https://doc.shengwang.cn/doc/rtc/javascript/advanced-features/image-enhancement",
        enDocUrl:
      ...
      },
      {
        ...
        zhDocUrl:
          "https://doc.shengwang.cn/doc/rtc/javascript/advanced-features/noise-reduction",
        enDocUrl:
      ...
      },
      {
        ...
        zhDocUrl:
          "https://doc.shengwang.cn/doc/rtc/javascript/advanced-features/super-clarity",
        enDocUrl:
      ...
      },
      {
        ...
        zhDocUrl:
          "https://doc.shengwang.cn/doc/rtc/javascript/advanced-features/video-compositing",
        enDocUrl:
  ...
  },
  {
    ...
    data: [
      {
        name: "react",
        url: `${ORIGIN_URL}/react/index.html`,
        zhDocUrl:
          "https://doc.shengwang.cn/api-ref/rtc/react/react-sdk/components",
        enDocUrl: "",
        githubUrl:
...
if (AREA == "external") {
  ...
  if (othersMenu.name == "othersMenu") {
    othersMenu.data = MENU_LIST[4].data.filter(
      (item) => item.name !== "pushStreamToCDN"
    );
    // add stt case
...
function __calcOriginUrl() {
  ...
  if (origin == "file://") {
    ...
    switch (ENV) {
      ...
      case "test":
        let TEST_PREFIX =
          AREA == "internal" ? INTERNAL_DEMO_PATH : EXTERNAL_DEMO_PATH;
